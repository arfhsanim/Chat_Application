...
import com.labproject.chatapp.databinding.ActivitySignUpBinding;
...
//            showToast("Confirm your password");
//            return false;
//        } else if (!binding.inputconfPassword.getText().toString().equals(binding.inputconfPassword.getText().toString())) {
//            showToast("Password and Confirm password must be same");
//            return false;
//        } else {
//            return true;
